...
from .language_pair_dataset_qe import LanguagePairDataset
from .language_pair_dataset_qe_word import LanguagePairWordDataset
...
@register_task('translation_m')
class TranslationMTask(FairseqTask):
    """
    ...
    def add_args(parser):
        ...
        # fmt: on
        # qe
        parser.add_argument('--ter', default=None, type=str,
                            help='amount to upsample primary dataset')
    ...
    def load_dataset(self, split, epoch=0, combine=False, shuffle=True, xml_dico=None, xml_params=None, task='translation_qe', **kwargs):
        ...
        # infer langcode
        src, tgt, ter = self.args.source_lang, self.args.target_lang, self.args.ter

        self.datasets[split] = load_langpair_dataset(
            data_path, split, src, self.src_dict, tgt, self.tgt_dict, ter, xml_dico, xml_params,
